...
class CachedThreedFront(ThreedFront):
    ...
    def __getitem__(self, i):
        ...
        print("room_layout")
        print(D["room_layout"])
        print("floor_plan_vertices")
        print(D["floor_plan_vertices"])
        print("floor_plan_faces")
        print(D["floor_plan_faces"])
        print("floor_plan_centroid")
        print(D["floor_plan_centroid"])
        print("class_labels")
        print(D["class_labels"])
        print("translations")
        print(D["translations"])
        print("sizes")
        print(D["sizes"])
        print("angles")
        print(D["angles"])
